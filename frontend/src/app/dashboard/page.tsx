...
function DashboardContent() {
  ...
  const getStatusBadge = (status: string) => {
    const badges = {
      ...
      questions_generated: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400",
      error: "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400",
    };
    return badges[status as keyof typeof badges] || "bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400";
  };
